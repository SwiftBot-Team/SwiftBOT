module.exports = [
	"Porque tem que ter uma cobra nas navegações? Porquê quando alguém se afoga, ela que dá o bote  ",
	"Plantas pequenas não falam pelo simples fato de serem mudas ",
	"O que o matemático falou ao indio? 8 Pi ",
	"Aonde moram os minions? Em condominios ",
	"Qual o tempero mais assassino da horta? A Mortelã ",
	"Por que o bombeiro não anda? Porque ele sócorre ",
	"Quando cantamos o hino ao contrario, ele passa a se chamar voltando ",
	"Porque o Mario e o Luigi foram  ao psicologo? Pois eles estavam passando por uma fase difícil ",
	"Qual é o rei dos queijos? O reiqueijão ",
	"Porque a mulher não pode ser eletricista? Porque ela demora 9 meses para dar a luz ",
	"Oque o livro de matemática disse para o livro de história? Não me venha com história que eu já estou cheio de problema ",
	"Quem fala errado: A Mônica ou o Cebolinha? A Mônica, ela fala errado e o Cebolinha fala ellado ",
	"Oque é, oque é, é redondo, tem um buraquinho no meio, tem duas letras cujo a primeira letra é C. CD  Não pense errado :)",
	"Qual é a diferença entre o padre e o bully? O bully, é de porcafé e o padre é de muita fé ",
	"O cigarro não te dá câncer. Você paga por ele.",
	"O cara que inventou o prédio, sonhou alto.",
	"Trabalhar em confeitaria é muito massa.",
	"Aquela construção se observa... a Construção Civil.",
	"Se um dia alguém te chamar de louco por você conversar com um saco de cimento, não se importe. Você apenas acredita no concreto.",
	"Queria fazer um suco... mas queria fazer ele beeeeeemmmm devagar... Qual devo fazer? O Suculento.",
	"Na delegacia \n" +
	...
	"O que é, o que é? Nunca volta, embora nunca tenha ido. \n" +
	"O passado.",
	...
	"O que é, o que é? A esfera disse para o cubo. \n" +
	"Deixa de ser quadrado.",

	"O que é, o que é? Há no meio do coração. \n" +
	"A letra “a”.",

	"O que é, o que é? Está sempre no meio da rua e de pernas para o ar.\n" +
	"A letra u.",
