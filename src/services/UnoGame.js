    ...
    constructor(client, message, thread_channel) {
        ...
        const emojis = {
            ...
            '2': {
                ...
                red: '<:yellow_two:926618695395078185>',
                yellow: '<:red_two:926618305744220250>'
            },
            '3': {
            ...
            '9': {
                ...
                green: '<:blue_nine:926617140889534494>',
        ...
        this.bolo = [
            ...
            ...Array(2).fill(true).map(() => ({ value: 'block', color: 'blue', emoji: emojis.block[3] })),
            ...Array(2).fill(true).map(() => ({ value: 'block', color: 'red', emoji: emojis.block[1] })),
            ...Array(2).fill(true).map(() => ({ value: 'block', color: 'green', emoji: emojis.block[0] })),
            ...Array(2).fill(true).map(() => ({ value: 'block', color: 'yellow', emoji: emojis.block[2] })),
