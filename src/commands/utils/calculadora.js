...
class Calculadora extends Base {
  ...
  async run({ message, args, prefix }, t) {
    ...
    if (!args[0]) return message.respond(t('commands:calculadora.exError'))
    ...
    try {
      ...
      if (['array', 'object', 'function', 'string'].includes(typeof result) || !result) return message.respond(t('commands:calculadora.error'))
      ...
      message.respond(t('commands:calculadora.error'))
    }
  }
}
