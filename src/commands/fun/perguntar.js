...
class Perguntar extends Base {
    ...
    async run({ message, args, prefix }, t) {
        if (!args[0]) return message.respond(new this.client.embed().setDescription(t('commands:perguntar.noArgs', {member: message.author.id})));
        ...
        return message.respond(`<:badgeA:795773919465963551> ${resposta}`)
    }
}
